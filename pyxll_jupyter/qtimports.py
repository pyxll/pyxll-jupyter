...
"""
try:
    from PySide2.QtWidgets import QApplication, QWidget, QVBoxLayout, QTabWidget, QTabBar
    from PySide2.QtWebEngineWidgets import QWebEngineView, QWebEngineProfile, QWebEnginePage
    from PySide2.QtCore import QUrl, Qt, Signal
except ImportError:
    from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QTabWidget, QTabBar
